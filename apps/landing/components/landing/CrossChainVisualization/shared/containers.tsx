    ...
    <div ref={ref} className={cn('relative z-20 flex flex-col items-center', className)}>
      ...
      {showLabels && (
        <div className="mb-3 flex items-center gap-1">
          ...
          <InfoTooltip
            content="The consolidated registry on Base stores stolen wallet, fraudulent transaction, and malicious contract reports from all chains. CAIP-10 compliant storage for wallet and contract addresses, with chain-qualified transaction references for cross-chain tracking (Ethereum, Solana, Bitcoin, etc.)."
