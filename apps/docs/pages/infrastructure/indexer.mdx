...
| ------------------------------ | --------------------------------- | --------------------------------------------------------------- |
| `WalletAcknowledged`           | `walletAcknowledgement`           | registeree, forwarder, status, gracePeriodStart, gracePeriodEnd |
...
| `TransactionBatchAcknowledged` | `transactionBatchAcknowledgement` | reporter, forwarder, dataHash, status                           |
