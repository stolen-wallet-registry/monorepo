...
5. Find `generateHashStruct(address forwarder, uint8 step)`
   - Enter your forwarder address (same as your address for standard registration) and `1` for acknowledgement
...
const signature = await signTypedData(walletClient, {
  domain: {
    name: 'StolenWalletRegistry',
    version: '4',
    chainId: 84532n, // Base Sepolia (use 8453n for Base mainnet)
