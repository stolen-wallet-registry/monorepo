export const OperatorSubmitterABI = [
  ...
  {
    type: 'function',
    name: 'proposeTransactionRegistry',
    inputs: [
      {
        name: '_transactionRegistry',
        type: 'address',
