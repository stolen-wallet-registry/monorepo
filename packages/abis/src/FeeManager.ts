export const FeeManagerABI = [
  ...
  {
    type: 'function',
    name: 'MAX_STALE_PRICE_THRESHOLD',
    inputs: [],
    outputs: [
      {
        name: '',
  ...
  {
    type: 'function',
    name: 'activateBaseFee',
    inputs: [
      {
        name: '_baseFeeUsdCents',
        type: 'uint256',
        internalType: 'uint256',
      },
    ],
  ...
  {
    type: 'function',
    name: 'activateFallbackPrice',
    inputs: [
      {
        name: '_fallbackEthPriceUsdCents',
        type: 'uint256',
        internalType: 'uint256',
      },
    ],
  ...
  {
    type: 'function',
    name: 'activateStalePriceThreshold',
    inputs: [
      {
  ...
  {
    type: 'function',
    name: 'proposeStalePriceThreshold',
    inputs: [
      {
        name: '_stalePriceThreshold',
        type: 'uint256',
  ...
  {
    type: 'event',
    name: 'FallbackSyncIntervalUpdated',
    inputs: [
      {
        name: 'oldInterval',
        type: 'uint256',
  ...
  {
    type: 'event',
    name: 'OraclePriceRejected',
    inputs: [
      {
        name: 'rejectedUsdCents',
        type: 'uint256',
        indexed: false,
        internalType: 'uint256',
      },
